                ...
                records.map((rec, i) => (
                  <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-indigo-600 font-semibold uppercase tracking-tighter">
                      {rec.checkInTime ? new Date(rec.checkInTime).toLocaleTimeString("en-US", { hour: '2-digit', minute: '2-digit', hour12: true }) : "—"}
                    </td>
                    <td className="px-6 py-4 text-rose-600 font-semibold uppercase tracking-tighter">
                      {rec.checkOutTime ? new Date(rec.checkOutTime).toLocaleTimeString("en-US", { hour: '2-digit', minute: '2-digit', hour12: true }) : (rec.checkInTime ? "Still In" : "—")}
                    </td>
